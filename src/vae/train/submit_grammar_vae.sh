#!/bin/bash
#SBATCH --job-name=grammar_vae_full
#SBATCH --output=logs/training/grammar_vae_%j.out
#SBATCH --error=logs/training/grammar_vae_%j.err
...
set -eo pipefail  # Removed -u to allow unset variables (SLURM_JOB_ID may not be set in all contexts)
...
echo "================================================================================"
echo "Grammar VAE Full Training"
echo "================================================================================"
...
echo "Logs: logs/training/grammar_vae_${SLURM_JOB_ID:-<job_id>}.{out,err}"
echo "================================================================================"
