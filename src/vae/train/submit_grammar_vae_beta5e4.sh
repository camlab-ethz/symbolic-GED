#!/bin/bash
#SBATCH --job-name=grammar_vae_beta5e4
#SBATCH --output=logs/training/grammar_vae_beta5e4_%j.out
#SBATCH --error=logs/training/grammar_vae_beta5e4_%j.err
...
echo "================================================================================"
echo "Grammar VAE Training (beta=5e-4)"
echo "================================================================================"
...
echo "Logs: logs/training/grammar_vae_beta5e4_${SLURM_JOB_ID:-<job_id>}.{out,err}"
echo "================================================================================"
