#!/bin/bash
#SBATCH --job-name=token_vae_beta1e2
#SBATCH --output=logs/training/token_vae_beta1e2_%j.out
#SBATCH --error=logs/training/token_vae_beta1e2_%j.err
...
echo "================================================================================"
echo "Token VAE Training (beta=1e-2)"
echo "================================================================================"
...
echo "Logs: logs/training/token_vae_beta1e2_${SLURM_JOB_ID:-<job_id>}.{out,err}"
echo "================================================================================"
